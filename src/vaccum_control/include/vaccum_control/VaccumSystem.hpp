...
#include "custom_interfaces/msg/float32_fixed_array8.hpp"
...
private:
    void encoder_counts_callback(const custom_interfaces::msg::Float32FixedArray8::SharedPtr msg);
    ...
    rclcpp::Subscription<custom_interfaces::msg::Float32FixedArray8>::SharedPtr enc_sub_;
